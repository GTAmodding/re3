...
const CMenuScreen aScreens[] = {
	...
	// MENUPAGE_STATS = 1
#ifdef MENU_MAP
	{ "FEP_STA", 1, MENUPAGE_NONE, MENUPAGE_NONE, 5, 3,
#else
	{ "FEP_STA", 1, MENUPAGE_NONE, MENUPAGE_NONE, 5, 2,
#endif
		MENUACTION_CHANGEMENU, "FEDS_TB", SAVESLOT_NONE, MENUPAGE_NONE,
	},

	// MENUPAGE_NEW_GAME = 2
	{ "FEP_STG", 1, MENUPAGE_NONE, MENUPAGE_NONE, 0, 1,
		MENUACTION_CHANGEMENU, "FES_NGA", SAVESLOT_NONE, MENUPAGE_NEW_GAME_RELOAD,
		MENUACTION_POPULATESLOTS_CHANGEMENU, "FES_LOA",  SAVESLOT_NONE, MENUPAGE_CHOOSE_LOAD_SLOT,
		MENUACTION_POPULATESLOTS_CHANGEMENU, "FES_DEL", SAVESLOT_NONE, MENUPAGE_CHOOSE_DELETE_SLOT,
		MENUACTION_CHANGEMENU, "FEDS_TB", SAVESLOT_NONE, MENUPAGE_NONE,
	},

	// MENUPAGE_BRIEFS = 3
#ifdef MENU_MAP
	{ "FEH_BRI", 1, MENUPAGE_NONE, MENUPAGE_NONE, 6, 4,
#else
	{ "FEH_BRI", 1, MENUPAGE_NONE, MENUPAGE_NONE, 6, 3,
#endif
		MENUACTION_CHANGEMENU, "FEDS_TB", SAVESLOT_NONE, MENUPAGE_NONE,
	},
	...
	{ "FEO_AUD", 1, MENUPAGE_OPTIONS, MENUPAGE_OPTIONS, 1, 1,
	...
	{ "FEO_DIS", 1, MENUPAGE_OPTIONS, MENUPAGE_OPTIONS, 2, 2,
	...
	{ "FEO_LAN", 1, MENUPAGE_OPTIONS, MENUPAGE_OPTIONS, 3, 3,
	...
	{ "FET_SG", 1, MENUPAGE_DISABLED, MENUPAGE_DISABLED, 0, 0,
		MENUACTION_CHANGEMENU,			"FET_SG",	SAVESLOT_NONE, MENUPAGE_CHOOSE_SAVE_SLOT,
	...
	{ "FET_CTL", 1, MENUPAGE_OPTIONS, MENUPAGE_OPTIONS, 0, 0,
		...
		MENUACTION_CHANGEMENU,	"FEC_RED", SAVESLOT_NONE, MENUPAGE_KEYBOARD_CONTROLS,
		MENUACTION_CHANGEMENU,	"FEC_MOU", SAVESLOT_NONE, MENUPAGE_MOUSE_CONTROLS,
   ...
   { "FET_OPT", 1, MENUPAGE_NONE, MENUPAGE_NONE, 1, 4,
		...
		MENUACTION_LOADRADIO,		"FEO_AUD", SAVESLOT_NONE, MENUPAGE_SOUND_SETTINGS,
		MENUACTION_CHANGEMENU,		"FEO_DIS", SAVESLOT_NONE, MENUPAGE_GRAPHICS_SETTINGS,
		MENUACTION_CHANGEMENU,		"FEO_LAN", SAVESLOT_NONE, MENUPAGE_LANGUAGE_SETTINGS,
		MENUACTION_PLAYERSETUP,		"FET_PS", SAVESLOT_NONE, MENUPAGE_SKIN_SELECT,
		MENUACTION_CHANGEMENU,		"FEDS_TB", SAVESLOT_NONE, MENUPAGE_NONE,
   },
   ...
   { "FEM_MM", 1, MENUPAGE_DISABLED, MENUPAGE_DISABLED, 0, 0,
		 ...
		 MENUACTION_CHANGEMENU,	"FEP_QUI",	SAVESLOT_NONE,	MENUPAGE_EXIT,
   },

   // MENUPAGE_PAUSE_MENU = 52
   { "FET_PAU", 1, MENUPAGE_DISABLED, MENUPAGE_DISABLED, 0, 0,
	   MENUACTION_RESUME,		"FEP_RES",	SAVESLOT_NONE, MENUPAGE_NONE, // There is FEI_RES and string value is exactly the same.
	   MENUACTION_CHANGEMENU,	"FEN_STA",	SAVESLOT_NONE, MENUPAGE_NEW_GAME,
#ifdef MENU_MAP
	   MENUACTION_CHANGEMENU,	"FEH_MAP",	SAVESLOT_NONE, MENUPAGE_MAP,
#endif
...
#ifdef MENU_MAP
   // MENUPAGE_MAP = 59
   { "FEH_MAP", 1, MENUPAGE_NONE, MENUPAGE_NONE, 5, 2,
